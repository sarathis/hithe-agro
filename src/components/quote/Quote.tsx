...
const SERVICE_ID = "service_bpv2drs"; // <-- replace with EmailJS service id
const TEMPLATE_ID = "template_yi3s1tn"; // <-- replace with EmailJS template id
const PUBLIC_KEY = "JB65xqEXAM0twEpiN"; // <-- replace with EmailJS public key
...
export default function Quote() {
  ...
  function validate() {
    ...
    if (!form.phone || form.phone.trim().length < 7)
      return "Valid phone/WhatsApp number is required";
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const templateParams = {
        ...form,
        productName:
          productsData.find((p) => p.id === form.productId)?.title ??
          form.productId,
      };
      ...
      console.error(err);
      setErrorMsg("❌ Failed to send inquiry via EmailJS. Please try again.");
    } finally {
      setLoading(false);
    }
  }
    ...
    <main className="pt-20 pb-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <p className="text-gray-600 mb-8">
          Fill in the details below and we'll send a tailored quote for your
          export requirement. Prefer WhatsApp or direct email? Use +91 6380667351
          or hithe.agro@gmail.com.
        </p>
        ...
        >
          ...
          <p className="text-sm text-gray-500 mt-2">
            By sending this request you agree we may contact you about your
            enquiry. For attachments or detailed specs, email{" "}
            <strong>info@hitheagro.com</strong>.
          </p>
        </form>
      </div>
    </main>
